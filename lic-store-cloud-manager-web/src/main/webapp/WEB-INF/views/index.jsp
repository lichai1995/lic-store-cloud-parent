...
<body class="easyui-layout">
    ...
    <div data-options="region:'west',title:'菜单',split:true" style="width:200px;">
    	<ul id="menu" class="easyui-tree" style="margin-top: 10px;margin-left: 10px;">
         	<li>
         		<span style="height: 40px;">商品管理</span>
         		<ul>
	         		<li class= "chai" data-options="attributes:{'url':'${ctx }/goods/add'}">新增商品</li>
	         		<li data-options="attributes:{'url':'${ctx }/goods/list'}">查询商品</li>
	         		<li data-options="attributes:{'url':'${ctx }/goods/attribute/list'}">规格参数</li>
	         	</ul>
         	</li>
         	<li>
         		<span>网站内容管理</span>
         		<ul>
	         		<li data-options="attributes:{'url':'${ctx }/content/category/tree'}">内容分类管理</li>
			...
			<li>
				<span>缓存管理</span>
				<ul>
					<li data-options="attributes:{'url':'${ctx }/cache/cleanGoodsCategory'}">清除缓存</li>
				</ul>
			</li>
         </ul>
    </div>
    ...
    <div region="south" split="true" style="height: 30px; background: #D2E0F2; ">
        <div class="footer">LIC有限公司@2018</div>
    </div>
