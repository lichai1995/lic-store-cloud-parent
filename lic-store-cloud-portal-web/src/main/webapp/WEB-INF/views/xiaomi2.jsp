...
<head>
    ...
    <style>
        *{
        ...
        .productlist1{width:90%;height:80%;
            margin: 0 auto;}
        .productlist1 li{float:left;padding:10px 20px;width:200px;}
        .productlist1 li img{border:solid 1px #ccc;
            margin: 10px 40px;}
        .productlist1 li dl dt{height:32px;line-height:16px;overflow:hidden;}
        .productlist1 li dl dd{padding:8px 0 0 55px;}
...
<script type="text/javascript">
    $(function(){
        $.post("/dosearch",{"currentPage":1,"pageSize":12,"keywords":"小米电脑"},function(res){
            //展示列表
            var htmlStr = '';
